...
namespace FarseerPhysics.Dynamics
{
    ...
    public class Body : IDisposable
    {
        ...
        {
            ApplyForceByRef(ref force, ref point);
        }
        ...
        public void ApplyForceByRef(ref Vector2 force)
        {
            ApplyForceByRef(ref force, ref Xf.Position);
        }
        ...
        /// <param name="force">The world force vector, usually in Newtons (N).</param>
        /// <param name="point">The world position of the point of application.</param>
        public void ApplyForceByRef(ref Vector2 force, ref Vector2 point)
        {
            if (_bodyType == BodyType.Dynamic)
            {
                if (Awake == false)
        ...
        public Vector2 GetLocalPointByRef(ref Vector2 worldPoint)
        {
        ...
        {
            return GetLocalPointByRef(ref worldPoint);
        }
